...
const Colormaps = ({currentOpen, setOpen} : {currentOpen: string, setOpen: React.Dispatch<React.SetStateAction<string>>}) => {
  ...
  return (
    <div style={{position:'relative'}}>
        ...
        <div className='panel-item-options' style={{transform: showOptions ? 'scale(100%) translateY(-50%)' : 'scale(0%) ', width:'auto', padding:'30px 10px', maxHeight:'600px', justifyContent:'space-around', overflow:'visible'}}>
